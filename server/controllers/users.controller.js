...
const createUsers= (req,res)=>{ 
    ...
    {
         SQLquery = 'INSERT INTO '+tableName+'(`Student_id`, `Student_name`, `email`, `phone`, `dept_id`, `password`) VALUES (?,?,?,?,?,?)';
         arr =[id, name, email, phone, dept_id, password];
    }
    else if(tableName==='teacher')
    {  SQLquery = 'INSERT INTO '+tableName+'(`teacher_id`, `teacher_name`, `email`, `phone`, `dept_id`, `password`) VALUES (?,?,?,?,?,?)';

       arr =[id, name, email, phone, dept_id, password];
    }
    else {

         SQLquery = 'INSERT INTO ' +tableName+'( `staff_id`, `staff_name`, `email`, `phone`, `password`)  VALUES (?,?,?,?,?)';
