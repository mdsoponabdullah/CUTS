...
if(count($_POST)>0)
{
    ...
    $query = "SELECT * FROM shuttles WHERE email='".$email."' and password='".$password."'";
    ...
    while($rows ){
        ...
        $_SESSION['shuttle_id'] = $rows["id"];
        $_SESSION['shuttle_name'] = $rows["name"];
        $_SESSION['shuttle_email'] = $rows["email"];
        header("Location:shuttleProfile.php");
        exit;
    }
...
<div class="mx-auto p-2 mt-5 shadow-lg p-3 mb-5 bg-body-tertiary rounded " style="width: 350px;">
    <form name="frmUser" method="post" action="" class="mx-auto p-2" style="width: 300px;">
        <div class="mb-3">
            ...
            <h3 align="center">Login as a Shuttle Operator</h3>
