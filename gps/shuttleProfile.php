...
// if(!isset($_SESSION['shuttle_id'])){
//     header("Location:shuttleLogin.php");
//     exit;
// }

if (isset($_POST['lat'])){
   //$bus_id = $_SESSION['shuttle_id'];
    $bus_id = $_SESSION['1'];

    $lat = $_POST['lat'];
    $lon = $_POST['lon'];

    $updateQuery = "UPDATE shuttles SET lat={$lat}, lon='{$lon}' WHERE id = {$shuttle_id}";
    ...
    if($executeQuery){
        ...
        return [
            "success"=>true,
            "message" => "Shuttle Location Updated"
        ];
    }
}
...
<div class="container">
    <div class="row">
        ...
        <div class="col-lg-6 mx-auto p-2 mt-5 shadow-lg p-3 mb-5 bg-body-tertiary rounded">
          ...
          <!-- Email  Shuttle Name : <?php echo $_SESSION['shuttle_name'];?><br> -->
          
 <br>
            <!-- Email : <?php echo $_SESSION['shuttle_email'];?><br> -->
