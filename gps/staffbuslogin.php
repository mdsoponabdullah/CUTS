...
if(count($_POST)>0)
{
    ...
    $query = "SELECT * FROM sbuses WHERE email='".$email."' and password='".$password."'";
    ...
    while($rows ){
        ...
        $_SESSION['bus_id'] = $rows["id"];
        $_SESSION['bus_name'] = $rows["name"];
        $_SESSION['bus_email'] = $rows["email"];
        header("Location:staffbusprofile.php");
        exit;
    }
...
<div class="mx-auto p-2 mt-5 shadow-lg p-3 mb-5 bg-body-tertiary rounded " style="width: 350px;">
    <form name="frmUser" method="post" action="" class="mx-auto p-2" style="width: 300px;">
        <div class="mb-3">
            ...
            <h3 align="center">Login as a Staff Bus Operator</h3>
